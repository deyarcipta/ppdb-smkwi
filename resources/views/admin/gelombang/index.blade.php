...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2 py-3">
    <div>
      <h5 class="mb-1"><i class="bx bx-time-five me-2 text-primary"></i>Daftar Gelombang Pendaftaran</h5>
      <small class="text-muted">Kelola jadwal dan tahapan pembukaan pendaftaran peserta baru.</small>
    </div>
    <button class="btn btn-primary btn-sm text-nowrap" data-bs-toggle="modal" data-bs-target="#addGelombangModal">
      <i class="bx bx-plus me-1"></i>Tambah Gelombang
    </button>
  </div>
